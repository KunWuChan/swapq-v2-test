# Swap Queue v2 — Branch Commit Reference

## Arm Relationship Diagram

```
                      v1 family (rc2)                    v2 family (rc5)
                      ================                    ================

              bdc38bfc126 (swapq-v1-before)        94f9b3980dd (swapq-v2-base)
              A: v1 baseline, 0 patches             D: v2 baseline, 0 patches
                        │                                      │
                        │ +8 patches                           │ +13 patches
                        ▼                                      ▼
              5d5c0f6c4e6 (swapq-v1-patch8)         aa162bca0b4 (swapq-v2)
              B: patches 1-8                        E: full v2, patches 1-13
                        │
                        │ +5 patches (priority queue + plist removal)
                        ▼
              9854da38189 (swapq-v1-patch13)
              C: full v1, patches 1-13
  ...
  C = B + 5 core patches (9-13):
    ...
    patch 10: remove available list
    patch 11: perform sync discard on single device more proactively
    patch 12: drop swap active plist
    patch 13: lib/plist.c: remove requeue function

  E = D + 13 patches (same structure as C, but on rc5 base):
    patch 9:  priority queue for swap device allocation
    patch 10: remove available list
    patch 11: bound synchronous discard during allocation
    patch 12: drop swap active plist
    patch 13: lib/plist.c: remove requeue function
```
...
| Arm | Branch | Commit | Base | Patches | Kernel |
|-----|--------|--------|------|:-------:|:------:|
| A | swapq-v1-before | `bdc38bfc126` | — | 0 | 7.2.0-rc2 |
| B | swapq-v1-patch8 | `5d5c0f6c4e6` | A | 8 | 7.2.0-rc2 |
| C | swapq-v1-patch13 | `9854da38189` | A | 13 | 7.2.0-rc2 |
| D | swapq-v2-base | `94f9b3980dd` | — | 0 | 7.2.0-rc5 |
| E | swapq-v2 | `aa162bca0b4` | D | 13 | 7.2.0-rc5 |